...
DiagrammeR::grViz("digraph {
                  ...
                  data1 [label = 'Teoría', shape = folder, fillcolor = Steelblue]
                  data2 [label = 'Método Numérico', shape = folder, fillcolor = Steelblue]
                  process [label =  'Algoritmos', fillcolor = Steelblue]
                  statistical [label = 'Creación de Funciones \n y Programas', fillcolor = Steelblue]
                  
                  
                  results [label= 'Resultados', fillcolor = Steelblue]
...
DiagrammeR::grViz("digraph {
                  ...
                  data1 [label = 'GitHub', shape = folder, fillcolor = Steelblue]
                  data2 [label = 'Documento \n Científico', shape = folder, fillcolor = Steelblue]
                  process [label =  'Repositorio', fillcolor = Steelblue]
                  statistical [label = 'Se crea el paquete', fillcolor = Steelblue]
                  
                  
                  results [label= 'Uso público \n o privado', fillcolor = Steelblue]
